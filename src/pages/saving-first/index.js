...
import saveImage from "../../images/gifs/save.png";
      ...
      contents = (
        <Prompt title="To Save or Not to Save?">
          ...
          <PromptSection className="text-center">
            <PromptButton onClick={this.chooseSaveOption}>Yes! Build an Emergency Corpus.</PromptButton>
            <PromptButton onClick={this.chooseSpendOption}>
              Nope! Buy a new bag instead.
            </PromptButton>
          </PromptSection>
        </Prompt>
      );
