...
export default class TransactionDetective extends Component {
  ...
  render() {
    ...
    if (mode === MODES.PROMPT) {
      contents = (
        <Prompt title="The bill comess due!">
          <PromptSection>
            <p>
            You've just received your monthly credit card statement and something looks fishy. 
            Among your usual purchases, you spot a few mysterious charges. Could these be fraudulent transactions? It’s time to put on your detective hat and figure it out!
            </p>
          </PromptSection>
      ...
      let header;
      const style = { textAlign: "center", color: "#111111", marginTop: 0, fontSize: "1.6rem" };
