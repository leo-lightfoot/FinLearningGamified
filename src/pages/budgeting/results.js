...
export function GreatResult({ nextRoute, ...otherProps }) {
  return (
    <Results
      title="Nice Job!"
      message="That’s the sweet spot! You are using less than 35% of your available credit. (Remember, paying your balance in full each month saves money and helps keep your overall balance and credit utilization low.)"
      nextRoute={nextRoute}
      {...otherProps}
    />
  );
...
export function BadResult({ nextRoute, ...otherProps }) {
  return (
    <Results
      title="Slow Down!"
      message="Whoa, you are spending more than 35% of your credit limit. Keep your balance to 35% or less of your limit in order to build your credit power."
      nextRoute={nextRoute}
      {...otherProps}
    />
  );
